...
// #################### ADD updates upon clicking axis text  ###############//
      ...
      yLabelsGroup.selectAll("text")
        ...
        // below are new codes added for zoon and pan!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! 
        // Pan and zoom
        var zoom = d3.zoom()
          .scaleExtent([.5, 20])
        ...
        function zoomed() {
          ...
          var new_xScale = d3.event.transform.rescaleX(xLinearScale);
          var new_yScale = d3.event.transform.rescaleY(yLinearScale);
          // update axes
          xAxis.call(bottomAxis.scale(new_xScale));
          yAxis.call(leftAxis.scale(new_yScale));
          circlesGroup.data(acsData)
            .attr('cx', function (d) { return new_xScale(d[chosenXAxis]) })
            .attr('cy', function (d) { return new_yScale(d[chosenYAxis]) });
          textGroup.data(acsData)
          .attr('x', function (d) { return new_xScale(d[chosenXAxis]*.99) })
          .attr('y', function (d) { return new_yScale(d[chosenYAxis]) });
          ...
          //   });
          // // Create Circles Tooltip in the Chart
          // var mo = chartGroup.selectAll("circle.stateCircle")
          // console.log(mo)
          // mo.call(toolTip);
          // // Create Event Listeners to Display and Hide the Circles Tooltip
          // mo.on("mouseover", function (data) {
          //   toolTip.show(data, this);
          //   console.log("moooooo");
          // })
